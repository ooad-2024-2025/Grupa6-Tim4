...
namespace BloomBox.Controllers
{
    public class LokacijaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("lokacijaId,lokacijaKorisnikaURL,lokacijaURL")] Lokacija lokacija)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("lokacijaId,lokacijaKorisnikaURL,lokacijaURL")] Lokacija lokacija)
        {
