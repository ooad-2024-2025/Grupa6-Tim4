...
namespace BloomBox.Controllers
{
    public class LokacijaController : Controller
    {
        ...
        // Nova funkcionalnost za mapu
        public async Task<IActionResult> Map()
        {
            var lokacije = await _context.Lokacija.ToListAsync();
        ...
        public async Task<IActionResult> GetLokacije()
        {
            ...
            var lokacije = await _context.Lokacija
            .Select(l => new
            {
                id = l.lokacijaId,
                adresa = l.Adresa,
        ...
        [HttpPost]
        public async Task<IActionResult> NajblizaLokacija([FromBody] KoordinateModel
        koordinate)
        {
            var lokacije = await _context.Lokacija.ToListAsync();
            if (!lokacije.Any())
            ...
            return Json(new
            {
                ...
                lokacija = new
                {
                    id = najbliza.lokacija.lokacijaId,
       ...
       // [Authorize(Roles = "Administrator, Radnik, Korisnik")]
        ...
        public async Task<IActionResult>Create([Bind("Id,Adresa,Grad,GeografskaSirina,GeografskaDuzina")] Lokacija
        lokacija)
        {
        ...
        public async Task<IActionResult> Edit(int id,
        [Bind("Id,Adresa,Grad,GeografskaSirina,GeografskaDuzina")] Lokacija lokacija)
        {
