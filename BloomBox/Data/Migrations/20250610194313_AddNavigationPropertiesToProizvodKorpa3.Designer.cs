...
namespace BloomBox.Data.Migrations
{
    ...
    [Migration("20250610194313_AddNavigationPropertiesToProizvodKorpa3")]
    partial class AddNavigationPropertiesToProizvodKorpa3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BloomBox.Models.Narudzba", b =>
                {
                    b.HasOne("BloomBox.Models.Korisnik", "Kupac")
                        .WithMany()
                        .HasForeignKey("KupacId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BloomBox.Models.AdresaDostave", "adresaDostave")
                        .WithMany()
                        .HasForeignKey("adresaDostaveId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Kupac");

                    b.Navigation("adresaDostave");
                });
            ...
            modelBuilder.Entity("BloomBox.Models.ProizvodKorpa", b =>
                {
                    ...
                    b.HasOne("BloomBox.Models.Narudzba", "Narudzba")
                        .WithMany()
                        .HasForeignKey("narudzbaId");

                    b.HasOne("BloomBox.Models.Proizvod", "Proizvod")
                        .WithMany()
