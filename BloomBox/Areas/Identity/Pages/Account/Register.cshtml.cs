    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [RegularExpression(@"^(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$",
                ErrorMessage = "Lozinka mora imati najmanje 8 karaktera, jedno veliko slovo, jednu cifru i jedan specijalni znak.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Korisnik je kreirao novi korisnički nalog sa šifrom.");
                    await _userManager.AddToRoleAsync(user, "Korisnik"); //postavlja automatski u ulogu Korisnik za sve nove korisnike
